                ...
                case ConstClass.TYPE_EMS:
                    {
                        ...
                        lbl_TimeTitle4.Text = "케이지 하강 시작 (ms)";
                        lbl_TimeTitle5.Text = "케이지 하강 완료 (ms)";
                        lbl_TimeTitle6.Text = "케이지 승강 시작 (ms)";
                        lbl_TimeTitle7.Text = "케이지 승강 완료 (ms)";
                        lbl_TimeTitle8.Text = "예비";
                        lbl_TimeTitle9.Text = "예비";
                        lbl_TimeTitle10.Text = "화물 적재 완료 (ms)";
                        lbl_TimeTitle11.Text = "To 출발 시작 (ms)";
                        lbl_TimeTitle12.Text = "To 도착 완료 (ms)";
                        lbl_TimeTitle13.Text = "케이지 하강 시작 (ms)";
                        lbl_TimeTitle14.Text = "케이지 하강 완료 (ms)";
                        lbl_TimeTitle15.Text = "케이지 승강 시작 (ms)";
                        lbl_TimeTitle16.Text = "케이지 승강 완료 (ms)";
                        lbl_TimeTitle17.Text = "예비";
                        lbl_TimeTitle18.Text = "예비";
