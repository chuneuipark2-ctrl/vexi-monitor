...
namespace VEXI
{
    public partial class Form_InvertorSt : Form
    {
        ...
        public Form_InvertorSt()
        {
            InitializeComponent();

            lbl_INV_St_6 = new Label[] { lbl_INV1_St_7, lbl_INV2_St_7, lbl_INV3_St_7, lbl_INV4_St_7, lbl_INV5_St_7, lbl_INV6_St_7 };
        ...
        public unsafe void Display_InvertorSt(byte[] datas)
        {
            ...
            fixed (VEXI_DEFS.TSRM_InvertorStRec* Ptr_1 = &dev_REC_Invertor.Invertor_1_St)
            {
                for (byte i = 0; i < 6; i++)
                {
                    if (Global_Class.BitStatus((Ptr_1 + i)->St, 6)) lbl_INV_St_6[i].Text = "1"; else lbl_INV_St_6[i].Text = "0";
